...
public class KeyServiceTest {
  ...
  @Autowired
  public KeyServiceTest(KeyService keyService, LanguageService languageService,
  ...
  public void updateTranslation() {
    ...
    keyService.updateTranslation(
        keyService.getKeyByName("attach_desc", groupService.getGroupByTitle("ui").getId(), false)
            .getId(),
  ...
  private KeyDTO createKeyDTO() {
    ...
    translations.put(languageService.getLanguageByLocale("fr").getId(),
        "S'il vous plaît contacter notre équipe");
